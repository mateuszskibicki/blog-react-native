...
export const setLoadingMailchimpStart = () => dispatch => {
  dispatch({ type: SET_LOADING_START_MAILCHIMP });
};

// Set loading to false -> mailchimp
export const setLoadingMailchimpStop = () => dispatch => {
  dispatch({ type: SET_LOADING_STOP_MAILCHIMP });
};

// Set error to true -> mailchimp
export const setErrorMailchimpTrue = message => dispatch => {
  dispatch({
...
export const setErrorMailchimpFalse = () => dispatch => {
  dispatch({ type: SET_MAILCHIMP_ERROR_FALSE });
};

// Set success to true -> mailchimp
export const setSuccessMailchimpTrue = () => dispatch => {
  dispatch({ type: SUBSCRIBE_TO_MAILCHIMP });
};

//subscribe to mailchimp main action
export const subscribeToMailchimp = email_address => async dispatch => {
  try {
